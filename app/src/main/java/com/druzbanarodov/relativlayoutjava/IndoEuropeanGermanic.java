...
public class IndoEuropeanGermanic extends SQLiteOpenHelper
{
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "indoeuropeangermanic.db";//NAME of database stored in Assets folder
    private static final String Table_name = "indoeuropeangermanic";//name of table
    ...
    public IndoEuropeanGermanic(Context context) {//constructor
