...
public class PaleoAsianEskimoAleutian extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "paleoasianeskimoaleutian.db";//NAME of database stored in Assets folder
    private static final String Table_name = "paleoasianeskimoaleutian";//name of table
    ...
    public PaleoAsianEskimoAleutian(Context context) {//constructor
