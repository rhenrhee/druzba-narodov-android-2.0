...
public class UralyUkagiryUkagirskaya extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "uralyukagiryukagirskaya.db";//NAME of database stored in Assets folder
    private static final String Table_name = "uralyukagiryukagirskaya";//name of table
    ...
    public UralyUkagiryUkagirskaya(Context context) {//constructor
