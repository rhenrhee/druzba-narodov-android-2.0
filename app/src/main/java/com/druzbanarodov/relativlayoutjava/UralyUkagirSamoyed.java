...
public class UralyUkagirSamoyed extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "uralyukagirsamoyed.db";//NAME of database stored in Assets folder
    private static final String Table_name = "uralyukagirsamoyed";//name of table
    ...
    public UralyUkagirSamoyed(Context context) {//constructor
