...
public class AltaiTurkic extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "altaiturkic.db";//NAME of database stored in Assets folder
    private static final String Table_name = "altaiturkic";//name of table
    ...
    public AltaiTurkic(Context context) {//constructor
