...
public class KartvelskayaGeorgian extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "kartvelskayageorgian.db";//NAME of database stored in Assets folder
    private static final String Table_name = "kartvelskayageorgian";//name of table
    ...
    public KartvelskayaGeorgian(Context context) {//constructor
