...
public class IndoEuropeanIranian extends SQLiteOpenHelper
{
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "indoeuropeaniranian.db";//NAME of database stored in Assets folder
    private static final String Table_name = "indoeuropeaniranian";//name of table
    ...
    public IndoEuropeanIranian(Context context) {//constructor
