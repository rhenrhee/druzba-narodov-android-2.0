...
public class IndoEuropeanSlavic extends SQLiteOpenHelper
{
    ...
    private static final String Database_name = "indoeuropeanslavic.db";//NAME of database stored in Assets folder
    private static final String Table_name = "indoeuropeanslavic";//name of table
    ...
    public IndoEuropeanSlavic(Context context) {//constructor
    ...
    private void createDB()
    {
        ...
        {
            String dbPath = this.getWritableDatabase().getPath();//Create an empty file
    ...
    public void openDatabase() throws SQLException//called by onCreate method of Questions Activity
    {
        ...
        //sqlite = SQLiteDatabase.openDatabase(myPath, null, SQLiteDatabase.OPEN_READWRITE);
        //sqlite = SQLiteDatabase.openDatabase(myPath, null, SQLiteDatabase.OPEN_READONLY);
        int i = 90;
    }
