...
public class PaleoAsianyEnisei extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "paleoasianyenisei.db";//NAME of database stored in Assets folder
    private static final String Table_name = "paleoasianyenisei";//name of table
    ...
    public PaleoAsianyEnisei(Context context) {//constructor
