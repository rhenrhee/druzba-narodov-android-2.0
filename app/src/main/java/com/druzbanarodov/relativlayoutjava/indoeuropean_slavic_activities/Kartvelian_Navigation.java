...
public class Kartvelian_Navigation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kartvelian_navigation);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        branch16 = (Button) findViewById(R.id.branch16);


        branch16.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(Kartvelian_Navigation.this, Questions.class);
                        intent.putExtra(Message, "branch16");//by this statement we are sending the name of the button that invoked the new Questions.java activity "Message" is defined by the name of the package + MESSAGE
