...
public class IndoEuropeanIndorian extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "indoeuropeanindorian.db";//NAME of database stored in Assets folder
    private static final String Table_name = "indoeuropeanindorian";//name of table
    ...
    public IndoEuropeanIndorian(Context context) {//constructor
