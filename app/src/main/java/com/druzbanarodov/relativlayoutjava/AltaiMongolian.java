...
public class AltaiMongolian extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "altaimongolian.db";//NAME of database stored in Assets folder
    private static final String Table_name = "altaimongolian";//name of table
    ...
    public AltaiMongolian(Context context) {//constructor
