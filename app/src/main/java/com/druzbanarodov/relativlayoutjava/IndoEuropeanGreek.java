...
public class IndoEuropeanGreek extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "indoeuropeangreek.db";//NAME of database stored in Assets folder
    private static final String Table_name = "indoeuropeangreek";//name of table
    ...
    public IndoEuropeanGreek(Context context) {//constructor
