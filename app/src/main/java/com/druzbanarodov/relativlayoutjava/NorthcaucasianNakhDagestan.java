...
public class NorthcaucasianNakhDagestan extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "northcaucasiannakhdagestan.db";//NAME of database stored in Assets folder
    private static final String Table_name = "northcaucasiannakhdagestan";//name of table
    ...
    public NorthcaucasianNakhDagestan(Context context) {//constructor
