...
public class NorthCaucasianAbkhazAdyghe extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "northcaucasianabkhazadyghe.db";//NAME of database stored in Assets folder
    private static final String Table_name = "northcaucasianabkhazadyghe";//name of table
    ...
    public NorthCaucasianAbkhazAdyghe(Context context) {//constructor
