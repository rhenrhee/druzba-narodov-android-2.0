...
public class AltaiKorean extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "altaikorean.db";//NAME of database stored in Assets folder
    private static final String Table_name = "altaikorean";//name of table
    ...
    public AltaiKorean(Context context) {//constructor
