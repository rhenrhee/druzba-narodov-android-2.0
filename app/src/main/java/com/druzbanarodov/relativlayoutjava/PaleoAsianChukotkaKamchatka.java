...
public class PaleoAsianChukotkaKamchatka extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "paleoasianchukotkakamchatka.db";//NAME of database stored in Assets folder
    private static final String Table_name = "paleoasianchukotkakamchatka";//name of table
    ...
    public PaleoAsianChukotkaKamchatka(Context context) {//constructor
