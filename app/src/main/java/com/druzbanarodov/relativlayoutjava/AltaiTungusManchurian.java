...
public class AltaiTungusManchurian extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "altaitungusmanchurian.db";//NAME of database stored in Assets folder
    private static final String Table_name = "altaitungusmanchurian";//name of table
    ...
    public AltaiTungusManchurian(Context context) {//constructor
