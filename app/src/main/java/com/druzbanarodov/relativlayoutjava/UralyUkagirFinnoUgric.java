...
public class UralyUkagirFinnoUgric extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.druzbanarodov.relativlayoutjava/";
    private static final String Database_name = "uralyukagirfinnougric.db";//NAME of database stored in Assets folder
    private static final String Table_name = "uralyukagirfinnougric";//name of table
    ...
    public UralyUkagirFinnoUgric(Context context) {//constructor
